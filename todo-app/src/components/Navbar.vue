...
import hamburger from "../assets/menuIcon.svg";
...
const toddleSidebar = ()=>{
    toggle.setToggleButton(!toggle.toggleDialogue);
}

</script>

<template>
    <div class="flex justify-between p-6 bg-white shadow w-screen fixed t0p-0">
